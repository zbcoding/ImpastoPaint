...
export const strings: Record<Lang, Dict> = {
  en: {
    ...
    linuxH3: 'Linux',
    linuxP: 'Prebuilt Linux binaries are on the releases page. The Flatpak is at FlatPark. The AppImage is for newer distributions.',
    linuxCta: 'Linux download',
    linuxFlatparkCta: 'FlatPark',
    linuxAppImageCta: 'AppImage (Ubuntu 26.04+, Fedora 44+, or Arch)',
    windowsH3: 'Windows',
  ...
  es: {
    ...
    linuxH3: 'Linux',
    linuxP: 'Los binarios precompilados para Linux están en la página de versiones. El Flatpak está en FlatPark. La AppImage es para distribuciones recientes.',
    linuxCta: 'Descargar para Linux',
    linuxFlatparkCta: 'FlatPark',
    linuxAppImageCta: 'AppImage (Ubuntu 26.04+, Fedora 44+ o Arch)',
    windowsH3: 'Windows',
  ...
  fr: {
    ...
    linuxH3: 'Linux',
    linuxP:
      "Les binaires précompilés pour Linux sont sur la page des versions. Le Flatpak est sur FlatPark. L'AppImage vise les distributions récentes.",
    linuxCta: 'Télécharger pour Linux',
    linuxFlatparkCta: 'FlatPark',
    linuxAppImageCta: 'AppImage (Ubuntu 26.04+, Fedora 44+ ou Arch)',
    windowsH3: 'Windows',
  ...
  de: {
    ...
    linuxH3: 'Linux',
    linuxP: 'Fertige Linux-Binärdateien gibt es auf der Releases-Seite. Das Flatpak liegt bei FlatPark. Das AppImage ist für neuere Distributionen.',
    linuxCta: 'Linux-Download',
    linuxFlatparkCta: 'FlatPark',
    linuxAppImageCta: 'AppImage (Ubuntu 26.04+, Fedora 44+ oder Arch)',
    windowsH3: 'Windows',
  ...
  ja: {
    ...
    linuxH3: 'Linux',
    linuxP: 'ビルド済みのLinuxバイナリはリリースページにあります。FlatpakはFlatParkにあります。AppImageは新しいディストリビューション向けです。',
    linuxCta: 'Linux版をダウンロード',
    linuxFlatparkCta: 'FlatPark',
    linuxAppImageCta: 'AppImage(Ubuntu 26.04+、Fedora 44+、Arch)',
    windowsH3: 'Windows',
  ...
  'zh-cn': {
    ...
    linuxH3: 'Linux',
    linuxP: '预编译的 Linux 二进制文件可在发布页面获取。Flatpak 在 FlatPark 上。AppImage 适用于较新的发行版。',
    linuxCta: '下载 Linux 版',
    linuxFlatparkCta: 'FlatPark',
    linuxAppImageCta: 'AppImage(Ubuntu 26.04+、Fedora 44+ 或 Arch)',
    windowsH3: 'Windows',
