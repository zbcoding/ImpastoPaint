...
export const strings: Record<Lang, Dict> = {
  en: {
    ...
    linuxH3: 'Linux',
    linuxP: 'Prebuilt Linux binaries are on the releases page. You can also get the Flatpak from FlatPark. The AppImage needs glibc 2.43 or newer, so it runs on Ubuntu 26.04, Fedora 44 and Arch but will not start on Ubuntu 24.04 or Fedora 43. Use the Flatpak there.',
    linuxCta: 'Linux download',
    linuxFlatparkCta: 'FlatPark',
    linuxAppImageCta: 'AppImage',
    windowsH3: 'Windows',
    windowsP: 'A native Windows build is published with every release. It is unsigned, so SmartScreen may warn you - click "More info" then "Run anyway" to continue.',
  ...
  es: {
    ...
    linuxH3: 'Linux',
    linuxP: 'Los binarios precompilados para Linux están en la página de versiones. También puedes obtener el Flatpak desde FlatPark. La AppImage necesita glibc 2.43 o posterior, así que funciona en Ubuntu 26.04, Fedora 44 y Arch, pero no arranca en Ubuntu 24.04 ni Fedora 43. Ahí usa el Flatpak.',
    linuxCta: 'Descargar para Linux',
    linuxFlatparkCta: 'FlatPark',
    linuxAppImageCta: 'AppImage',
    windowsH3: 'Windows',
    windowsP: 'Con cada versión se publica una compilación nativa para Windows. No está firmada, así que SmartScreen puede advertirte: haz clic en "Más información" y luego en "Ejecutar de todos modos".',
  ...
  fr: {
    ...
    linuxH3: 'Linux',
    linuxP:
      "Des binaires précompilés pour Linux sont disponibles sur la page des versions. Vous pouvez aussi obtenir le Flatpak depuis FlatPark. L'AppImage exige glibc 2.43 ou plus récent : elle fonctionne sur Ubuntu 26.04, Fedora 44 et Arch, mais ne démarre pas sur Ubuntu 24.04 ni Fedora 43. Utilisez le Flatpak dans ce cas.",
    linuxCta: 'Télécharger pour Linux',
    linuxFlatparkCta: 'FlatPark',
    linuxAppImageCta: 'AppImage',
    windowsH3: 'Windows',
    windowsP: "Une version native pour Windows est publiée à chaque version. Elle n'est pas signée, donc SmartScreen peut vous avertir : cliquez sur « Plus d'infos » puis « Exécuter quand même ».",
  ...
  de: {
    ...
    linuxH3: 'Linux',
    linuxP: 'Fertige Linux-Binärdateien gibt es auf der Releases-Seite. Das Flatpak gibt es auch bei FlatPark. Das AppImage benötigt glibc 2.43 oder neuer und läuft daher auf Ubuntu 26.04, Fedora 44 und Arch, startet aber nicht auf Ubuntu 24.04 oder Fedora 43. Nutzen Sie dort das Flatpak.',
    linuxCta: 'Linux-Download',
    linuxFlatparkCta: 'FlatPark',
    linuxAppImageCta: 'AppImage',
    windowsH3: 'Windows',
    windowsP: 'Mit jedem Release wird ein natives Windows-Build veröffentlicht. Es ist unsigniert, daher warnt SmartScreen möglicherweise - auf "Weitere Informationen" und dann "Trotzdem ausführen" klicken.',
    windowsCta: 'Windows-Download',
    macosH3: 'macOS',
  ...
  ja: {
    ...
    linuxH3: 'Linux',
    linuxP: 'ビルド済みのLinuxバイナリはリリースページにあります。FlatParkからFlatpak版を入手することもできます。AppImageにはglibc 2.43以降が必要なため、Ubuntu 26.04、Fedora 44、Archでは動作しますが、Ubuntu 24.04やFedora 43では起動しません。その場合はFlatpak版をお使いください。',
    linuxCta: 'Linux版をダウンロード',
    linuxFlatparkCta: 'FlatPark',
    linuxAppImageCta: 'AppImage',
    windowsH3: 'Windows',
    windowsP: 'リリースごとにネイティブのWindowsビルドが公開されます。署名されていないため、SmartScreenで警告が出ることがあります。「詳細情報」→「実行」を選んでください。',
  ...
  'zh-cn': {
    ...
    linuxH3: 'Linux',
    linuxP: '预编译的 Linux 二进制文件可在发布页面获取。你也可以从 FlatPark 获取 Flatpak 版本。AppImage 需要 glibc 2.43 或更高版本,因此可在 Ubuntu 26.04、Fedora 44 和 Arch 上运行,但在 Ubuntu 24.04 或 Fedora 43 上无法启动。请在这些系统上使用 Flatpak 版本。',
    linuxCta: '下载 Linux 版',
    linuxFlatparkCta: 'FlatPark',
    linuxAppImageCta: 'AppImage',
    windowsH3: 'Windows',
    windowsP: '每次发布都会提供原生 Windows 构建版本。由于未签名,SmartScreen 可能会发出警告 —— 点击"更多信息"再点击"仍要运行"即可继续。',
